...
const playRound = (pSelection, computerSelection) => {
  switch (pSelection + computerSelection) {
    ...
    case "paperrock":
      playerScore++;
      roundCounter++;
      return "You chose " + pSelection + " and the computer chose " + computerSelection + " , YOU WIN!";
    case "paperscissors":
    case "scissorsrock":
    case "rockpaper":
      computerScore++;
      roundCounter++;
      return "You chose " + pSelection + " and the computer chose " + computerSelection + " , YOU LOSE!";
    case "scissorsscissors":
    case "rockrock":
    case "paperpaper":
      roundCounter++;
      return "You chose " + pSelection + " and the computer chose " + computerSelection + " , ITS A DRAW!";
  }
